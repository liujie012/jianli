    ...
    Slide.prototype = {
        init: function(){
            ...
            if(opt.winW / opt.winH <= opt.desW / opt.desH){
                //opt.ele.style.webkitTransform = 'scale('+ opt.winH / opt.desH+')';
                //document.documentElement.style.fontSize = 16*opt.winH / opt.desH + 'px';
                var style = 'cover;'
            }else{
                //opt.ele.style.webkitTransform = 'scale('+  opt.winW / opt.desW+')';
                //document.documentElement.style.fontSize = 16*opt.winW / opt.desW + 'px';
                var style = 'contain;'
            };
